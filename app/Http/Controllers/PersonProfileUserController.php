...
class PersonProfileUserController extends Controller
{
    public function index()
    {
        ...
        return view('admin.person.PersonProfileAUserView', [
    ...
    public function edit()
    {
        ...
        return view('admin.person.EditPersonProfileUserView', [
            'departments' => $departments,
            'municipalities' => $municipalities,
            'document_types' => $document_types,
            'user' => $user[0],
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('user_profile')->with('success', $message);
        } catch (QueryException $e) {
            $message = 'no se pudo actualizar el usuario';
            return redirect()->route('user_edit_profile')->with('error', $message);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return redirect()->route('user_profile')->with('error', $message);
        }
    }
}
