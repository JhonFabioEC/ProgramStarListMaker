...
@section('content')
    <div class="container d-flex justify-content-center align-items-center mt-3">
        <div class="col-10">
            <form action="{{ route('updatePersonUser') }}" method="POST" enctype="multipart/form-data" class="form shadow-lg rounded p-4">
                @method('PUT')
                @csrf
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <div class="custom-file">
                            <input type="file" class="form-control custom-file-input" name="image" id="customFile"
                                placeholder="Selecciona una imagen" value="{{ old('image', $user) }}">
                        ...
                        <div class="form-outline">
                            <div class="form-group text-right">
                                <div class="btns-group">
                                    <button type="button"
                                        onclick="location.href='{{ route('user_profile') }}';"
